      ...
      this.cookingDataService.cookingData.subscribe(
        (cookingData: CookingData) => {
          if (cookingData) {
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.baking.length;
              i++
            ) {
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.dairy.length;
              i++
            ) {
              this.userIngredients =
                this.userIngredients +
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.meats.length;
              i++
            ) {
              this.userIngredients =
                this.userIngredients +
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.produce.length;
              i++
            ) {
              this.userIngredients =
                this.userIngredients +
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.seafood.length;
              i++
            ) {
              this.userIngredients =
                this.userIngredients +
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.snacks.length;
              i++
            ) {
              this.userIngredients =
                this.userIngredients +
            ...
            for (
              let i = 0;
              i < this.cookingData.user_ingredients.misc.length;
              i++
            ) {
              this.userIngredients =
                this.userIngredients +
            ...
            this.myRecipes
              .recipesWithPantry(this.userIngredients)
              .subscribe((temp: any) => {
                if (temp) {
                  for (let i = 0; i < 3; i++) {
                    this.recipes[i] = temp[i];
