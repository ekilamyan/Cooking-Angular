...
export class PantryService {
  public baseUrl_1 = 'https://api.spoonacular.com/food/ingredients/autocomplete';
  public baseUrl_2 = 'https://api.spoonacular.com/recipes/informationBulk';
  public baseUrl_3 = 'https://api.spoonacular.com/recipes/findByIngredients';

  public baseURL5 = 'https://api.spoonacular.com/recipes/findByIngredients';
  public apiKey = '7c71dbc02a1b4b1b8cc6ce764cef2be7';
  ...
  getIngredientAutocomplete(item: string): Observable<any> {
    return this.http.get(this.baseUrl_1 + '?query=' + item + '&number=20&metaInformation=true&apiKey=' + this.apiKey);
  }

  getMyRecipesIds(ingredients: string): Observable<any> {
    return this.http.get(this.baseUrl_3 + '?ignorePantry=true&ingredients=' + ingredients + '&apiKey=' + this.apiKey);
  }

  recipesWithPantry(ingredients: string): Observable<any> {
    return this.http.get(this.baseUrl_3 + '?ignorePantry=true&number=16&ingredients=' + ingredients + '&apiKey=' + this.apiKey);
  }
...
// getIngredientAutocomplete(item: string): Observable<any> {
// return this.http.get(this.baseUrl_1 + '?query=' + item + '&number=20&metaInformation=true', { headers: this.headers });
// }

// getMyRecipesIds(ingredients: string): Observable<any> {
// return this.http.get(this.baseUrl_3 + '?ignorePantry=true&ingredients=' + ingredients, { headers: this.headers });
// }

// // recipesWithPantry(ingredients: string): Observable<any> {
// //   return this.http.get(this.baseURL5 + '?ignorePantry=true&number=16&ingredients=' + ingredients + '&apiKey=' + this.apiKey);
// // }

// recipesWithPantry(ingredients: string): Observable<any> {
// return this.http.get(this.baseUrl_3 + '?ignorePantry=true&number=16&ingredients=' + ingredients, { headers: this.headers });
// }
